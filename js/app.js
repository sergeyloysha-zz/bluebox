...
$(function() {
  ...
  $(document).click( function(e) {
    var container = $('.nav__dropdown, .nav__link');
    if (!container.is(e.target) && container.has(e.target).length === 0) {
      $('.nav__dropdown').removeClass('nav__dropdown_active');
      $('.nav__dropdown').prev().removeClass('nav__link_active');
    }
  });
  ...
  $('.nav__link_dropdown').on('click', function(e) {
    ...
    $(this).next().toggleClass('nav__dropdown_active');
  });
  ...
  $('.map')
    ...
    .on('click', function (marker) {
      marker.setIcon('http://maps.google.com/mapfiles/marker_blue.png');
    });
});
